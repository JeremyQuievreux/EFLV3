...
const PremierLeague = () => {
  return (
    <div className={styles.main_container}>
      <Head>
        <title>EFL | Premier League | Accueil</title>
      ...
      <div className={styles.cards_container}>
        <Link href="/premier_league/results">
        ...
        <Link href="/premier_league/ranking">
        <div className={styles.card}>
          <div className={styles.icon_container}>
        ...
        <Link href="/premier_league/calendar">
        <div className={styles.card}>
          <div className={styles.icon_container}>
        ...
        <Link href="/premier_league/teams">
        <div className={styles.card}>
          <div className={styles.icon_container}>
